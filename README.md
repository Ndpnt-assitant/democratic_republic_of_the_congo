# OpenFisca Democratic Republic Of The Congo
...
These elements are described in different folders. All the modelling happens within the `openfisca_democratic_republic_of_the_congo` folder.
...
```sh
pip install openfisca-democratic_republic_of_the_congo
```
...
```sh
git clone git://github.com/Ndpnt-assitant/democratic_republic_of_the_congo.git.git
cd democratic_republic_of_the_congo.git
...
```sh
openfisca serve --port 5000 --country-package openfisca_democratic_republic_of_the_congo
```
...
curl -X POST -H "Content-Type: application/json" \
  -d @./openfisca_democratic_republic_of_the_congo/situation_examples/couple.json \
